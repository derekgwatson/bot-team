...
# Import ExternalStaffDB directly using importlib to avoid sys.modules caching issues
module_path = quinn_path / 'database' / 'db.py'
spec = importlib.util.spec_from_file_location('quinn_database_db', module_path)
