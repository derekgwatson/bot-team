"""
Authentication routes for Mavis
    ...
    try:
        ...
        if not user_info:
            return render_template_string('''
                ...
                <body style="font-family: sans-serif; max-width: 600px; margin: 50px auto; text-align: center;">
                    <h1 style="color: #9b59b6;">Login Failed</h1>
                    <p>Could not retrieve user information from Google.</p>
                    <p><a href="{{ url_for('auth.login') }}" style="color: #9b59b6;">Try Again</a></p>
                </body>
                </html>
            ''')
        ...
        if not staff_check.get('approved'):
            ...
            return render_template_string('''
                ...
                <body style="font-family: sans-serif; max-width: 600px; margin: 50px auto; text-align: center;">
                    <h1 style="color: #9b59b6;">Access Denied</h1>
                    <p>{{ error_msg }}</p>
                    <p>Only staff members can access Mavis.</p>
                    <p style="margin-top: 20px; color: #666; font-size: 14px;">
                        Email: {{ email }}
                    </p>
                    <p style="margin-top: 30px;">
                        <a href="{{ url_for('auth.login') }}" style="color: #9b59b6;">Try a different account</a>
                    </p>
                </body>
                </html>
        ...
        return render_template_string('''
            ...
            <body style="font-family: sans-serif; max-width: 600px; margin: 50px auto; text-align: center;">
                <h1 style="color: #9b59b6;">Login Error</h1>
...
def logout():
    ...
    return render_template_string('''
        ...
        <body style="font-family: sans-serif; max-width: 600px; margin: 50px auto; text-align: center;">
            <h1 style="color: #9b59b6;">Logged Out</h1>
