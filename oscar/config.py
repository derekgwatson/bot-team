...
class Config:
    ...
    @property
    def name(self):
        return self._config.get('name', 'oscar')
    ...
    def server_port(self):
        return self._config.get('server', {}).get('port', 8011)
    ...
    def email_from_address(self):
        return self._config.get('email', {}).get('from_address', 'oscar@watsonblinds.com.au')
