...
class Database:
    """Database manager for Zac's pending operations"""
    ...
    def queue_operation(self, operation_type: str, operation_data: Dict[str, Any],
        ...
        # Extract target info for easy lookup
        target_email = operation_data.get('email', '')
        target_name = operation_data.get('name', '')
        target_user_id = operation_data.get('user_id')

        cursor.execute("""
            INSERT INTO pending_operations (
                operation_type, operation_data, target_email, target_name, target_user_id,
