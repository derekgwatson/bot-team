-- Fred's Pending Operations Database Schema
-- Tracks queued operations that can be executed later

CREATE TABLE IF NOT EXISTS pending_operations (
    id INTEGER PRIMARY KEY AUTOINCREMENT,

    -- Operation type: create_user, archive_user, delete_user, restore_user
    ...
    -- Results
    result_data TEXT DEFAULT NULL,  -- JSON blob with result (password, backup codes, etc.)
